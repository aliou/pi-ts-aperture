...
- Adds the `openaiRoute` setting for Aperture deployments that expose OpenAI-compatible routes at the gateway root instead of `/v1`; the standard `/v1` route remains the default.
